#!/usr/bin/env sh
# Universal installer for uncensored-fleet. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/uncensored-fleet.git"
echo "Installing uncensored-fleet ..."
...
echo "Done. Run: uncensored-fleet --help"
