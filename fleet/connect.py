"""Native cognis-connect emit for uncensored-fleet — forward findings to any platform.

Maps uncensored-fleet's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    uncensored-fleet ... --format json | uncensored-fleet-emit --to stix
    uncensored-fleet-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
